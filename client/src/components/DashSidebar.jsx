...
const DashSidebar = () => {
  ...
  return (
    <div className="sidebar dark:bg-gray-800 dark:text-white bg-slate-100 w-52 h-screen space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
      {/* Profile Section */}
