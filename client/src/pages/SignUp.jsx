  ...
  return (
    ...
    {/* left - container */}
      ...
      <Link  className='self-centre whitespace-nowrap text-sm sm:text-xl font-semibold dark:text-white mt-4' >
        <span className=' hover:text-black  px-2 text-white py-1 bg-gradient-to-r from-blue-500 via-violet-500 to-pink-400 rounded-lg text-4xl hover:duration-700'>Krashna's</span>
